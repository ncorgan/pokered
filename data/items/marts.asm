...
; Viridian
ViridianCashierText::
	script_mart GREAT_BALL, ANTIDOTE, PARLYZ_HEAL, BURN_HEAL

; Pewter
PewterCashierText::
	script_mart GREAT_BALL, SUPER_POTION, ESCAPE_ROPE, ANTIDOTE, BURN_HEAL, AWAKENING, PARLYZ_HEAL

; Cerulean
CeruleanCashierText::
	script_mart GREAT_BALL, SUPER_POTION, REPEL, ANTIDOTE, BURN_HEAL, AWAKENING, PARLYZ_HEAL
